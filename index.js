      ...
      if (!structure.length) {
        ...
        structure.map(function (entry) {
          if (entry.__proto__ == Object.prototype) {
            structureObj = Object.assign({}, structureObj, _defineProperty({}, entry._id, flattenStructure(entry)));
          } else {
    ...
    var _ret2 = function () {
      ...
      Object.keys(structure).map(function (key) {
        if (structure[key].__proto__ == Array.prototype) {
          structureObj = Object.assign({}, structure, structureObj, _defineProperty({}, key, flattenStructure(structure[key])));
        }
      });
      return {
        v: structureObj
